...
public class Engineering extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Engineering Building");
        ...
        try {
          ...
          //  String data = getIntent().getExtras().toString();
            ...
            if (getIntent().getExtras() == null) {
                ...
                String end_lat = String.valueOf(37.335142);
                String end_lon = String.valueOf(-121.881276);
    ...
    {
        Log.d("click", "click street view on engg");

        Intent i = new Intent(getApplicationContext(), MapsActivity.class);
        i.putExtra("building","EB");
        i.putExtra("lat", String.valueOf(37.337325));
        i.putExtra("lon", String.valueOf(-121.882481));
        startActivity(i);
