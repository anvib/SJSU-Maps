...
public class yoshihiro extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.d("check", "reached yoshihiro");
        setContentView(R.layout.activity_yoshihiro);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Yoshihiro Uchida Hall");
        ...
        try {
            ...
            if (getIntent().getExtras() == null) {
                ...
                String end_lat = String.valueOf(37.333770);
                String end_lon = String.valueOf(-121.883388);
    ...
    {
        Log.d("click", "click street view on YUH");

        Intent i = new Intent(getApplicationContext(), MapsActivity.class);
        i.putExtra("building","YUH");
        i.putExtra("lat", String.valueOf(37.333558));
        i.putExtra("lon", String.valueOf(-121.884016));
        startActivity(i);
