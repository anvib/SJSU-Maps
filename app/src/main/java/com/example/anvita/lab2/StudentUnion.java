...
public class StudentUnion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Student Union");
        ...
        try {
            ...
            if (getIntent().getExtras() == null) {
                ...
                String end_lat = String.valueOf(37.424197);
                String end_lon = String.valueOf(-122.170939);
    ...
    {
        Log.d("click", "click street view on SU");

        Intent i = new Intent(getApplicationContext(), MapsActivity.class);
        i.putExtra("building","SU");
        i.putExtra("lat", String.valueOf(37.336854));
        i.putExtra("lon", String.valueOf(-121.879640));
        startActivity(i);
