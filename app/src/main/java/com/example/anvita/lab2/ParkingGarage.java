...
public class ParkingGarage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_parking_garage);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("South Parking Garage");
        ...
        try {
            ...
            if (getIntent().getExtras() == null) {
                ...
                String end_lat = String.valueOf(37.333474);
                String end_lon = String.valueOf(-121.879916);
    ...
    {
        Log.d("click", "click street view on SPG");

        Intent i = new Intent(getApplicationContext(), MapsActivity.class);
        i.putExtra("lat", String.valueOf(37.332721));
        i.putExtra("lon", String.valueOf(-121.880669));
        i.putExtra("building","SPG");
        startActivity(i);
