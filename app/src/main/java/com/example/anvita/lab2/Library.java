...
public class Library extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("King Library");
        ...
        try {
            ...
            if (getIntent().getExtras() == null) {
                ...
                String end_lat = String.valueOf(37.335507);
                String end_lon = String.valueOf(-121.884999);
    ...
    {
        Log.d("click", "click street view on library");

        Intent i = new Intent(getApplicationContext(), MapsActivity.class);
        i.putExtra("building","KL");
        i.putExtra("lat", String.valueOf(37.335669));
        i.putExtra("lon", String.valueOf(-121.885546));
        startActivity(i);
